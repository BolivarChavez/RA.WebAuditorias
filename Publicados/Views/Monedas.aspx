<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Monedas.aspx.cs" Inherits="WebAuditorias.Views.Monedas" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <title>Catálogo de monedas</title>
...
<body style="background-color: #E5E8E8;">
        <div class="container-fluid">
            <div class="row header-bar-height" style="background-color: #E5E8E8;">
                ...
                <div class="col-sm-12 col-md-8 col-lg-8 col-xl-8 center-block text-left my-auto">
                    <p class="barra-titulo" style="color:#2C3E50;">Catálogo de monedas</p>
                </div>  
                        ...
                        <form id="form1" runat="server">
                            ...
                            <ContentTemplate>
                                <nav class="navbar navbar-expand-lg">
                                    ...
                                    <button class="btn btn-outline-dark navbar-btn boton-buscar boton-margen" id="BtnBuscar" runat="server" onserverclick="BtnBuscar_ServerClick" data-toggle="tooltip" data-placement="bottom" title="Busca registros de monedas"></button>
                                    <button class="btn btn-outline-dark navbar-btn boton-grabar boton-margen" id="BtnGrabar" runat="server" onserverclick="BtnGrabar_ServerClick" data-toggle="tooltip" data-placement="bottom" title="Graba registro de moneda"></button>
                                    <button class="btn btn-outline-dark navbar-btn boton-eliminar boton-margen" id="BtnEliminar" runat="server" onserverclick="BtnEliminar_ServerClick" data-toggle="tooltip" data-placement="bottom" title="Elimina registro de moneda"></button>
                                </nav>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Catálogo de monedas</h5>
        ...
        <script src="../Scripts/Monedas.js" type="text/javascript"></script>
        <script>
