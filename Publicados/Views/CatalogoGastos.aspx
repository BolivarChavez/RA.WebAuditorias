<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CatalogoGastos.aspx.cs" Inherits="WebAuditorias.Views.CatalogoGastos" %>
...
<head runat="server">
    ...
    <title>Catálogo de gastos asociados a auditorías</title>
...
<body style="background-color: #E5E8E8;">
        <div class="container-fluid">
            <div class="row header-bar-height" style="background-color: #E5E8E8;">
                ...
                <div class="col-sm-12 col-md-8 col-lg-8 col-xl-8 center-block text-left my-auto">
                    <p class="barra-titulo" style="color:#2C3E50;">Catálogo de gastos asociados a auditorías</p>
                </div>  
                        ...
                        <form id="form1" runat="server">
                            ...
                            <ContentTemplate>
                                <nav class="navbar navbar-expand-lg">
                                    ...
                                    <button class="btn btn-outline-dark navbar-btn boton-buscar boton-margen" id="BtnBuscar" runat="server" onserverclick="BtnBuscar_ServerClick" data-toggle="tooltip" data-placement="bottom" title="Busca registros de catálogo de gastos"></button>
                                    <button class="btn btn-outline-dark navbar-btn boton-grabar boton-margen" id="BtnGrabar" runat="server" onserverclick="BtnGrabar_ServerClick" data-toggle="tooltip" data-placement="bottom" title="Graba registro de catálogo de gastos"></button>
                                    <button class="btn btn-outline-dark navbar-btn boton-eliminar boton-margen" id="BtnEliminar" runat="server" onserverclick="BtnEliminar_ServerClick" data-toggle="tooltip" data-placement="bottom" title="Elimina registro de catálogo de gastos"></button>
                                </nav>
                                <div id="DivOpciones" class="px-2" runat="server">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            <label for="Categoria" class="col-form-label col-form-label-sm" style="font-weight:bold;">Categoria de gasto</label>
                                            <asp:DropDownList ID="Categoria" CssClass="form-select form-select-sm" style="width: 300px; font-size: 12px" runat="server"></asp:DropDownList>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="Descripcion" class="col-form-label col-form-label-sm" style="font-weight:bold;">Descripción</label>
                                            <input type="text" class="form-control form-control-sm" style="font-size: 12px" id="Descripcion" placeholder="" runat="server" maxlength="100"/>
                                        </div>
                                    </div>
                                    <div class="row">
        ...
        <script src="../Scripts/CatalogoGastos.js" type="text/javascript"></script>
        <script>
