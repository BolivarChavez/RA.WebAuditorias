                                    ...
                                    <form id="form1" runat="server">
                                        ...
                                        <ContentTemplate>
                                            ...
                                            <div id="DivOpciones" class="px-2" style="overflow-x: hidden; overflow-y: auto" runat="server">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-3">
                                                        <label for="CodigoReembolso" class="col-form-label col-form-label-sm" style="font-weight:bold;">Codigo reembolso</label>
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        ...
                                                        <input type="text" class="form-control form-control-sm" id="ReferenciaReembolso" placeholder="" runat="server"/>
                                                    </div>
                                                    <div class="form-group col-md-3">
