async function CallServerMethod() {
    ...
    $.ajax({
        ...
        cache: false,
        type: "POST",
        url: "Monedas.aspx/ConsultaModedas",
...
function rowSelected(args) {
    document.getElementById('Codigo').value = args.data.mo_codigo;
    document.getElementById('Descripcion').value = args.data.mo_descripcion;
    document.getElementById("chkEstado").checked = (args.data.mo_estado === 'A') ? true : false;
}
