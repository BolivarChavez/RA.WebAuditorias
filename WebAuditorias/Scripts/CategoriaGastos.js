...
function ValidaDatos() {
    ...
    if (descripcion.trim() === "") {
        document.getElementById('messageContent').innerHTML = "ERROR : No se ha ingresado una descripción para la categoría de gasto";
...
function GrabarGategoria() {
    ...
    if (confirm("Confirma la grabación del registro de categoría de gasto?")) {
        strParametro = "1|";
...
function EliminarCategoria() {
    ...
    if (confirm("Confirma la eliminación del registro de categoría de gasto?")) {
        strParametro = "1|";
        strParametro += document.getElementById('Codigo').value + "|";
        strParametro += document.getElementById('Descripcion').value + "|";
        strParametro += "X";
