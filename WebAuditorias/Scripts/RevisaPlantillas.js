...
async function seleccionTarea(args) {
    ...
    document.getElementById("TituloSeccion4").innerHTML = "<b>Plantillas asociadas a tarea : " + args.data.ct_descripcion + "</b>";
...
async function ConsultaInicial() {
    document.getElementById("TituloSeccion4").innerHTML = "<b>Plantillas asociadas a tarea</b>";
...
async function rowSelected(args) {
    ...
    document.getElementById("GridFinConsultaProcesos").scrollIntoView();
}
