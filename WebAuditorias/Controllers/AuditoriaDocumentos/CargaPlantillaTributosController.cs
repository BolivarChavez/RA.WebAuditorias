                ...
                foreach (DataRow row in data.Rows)
                {
                    if (row[0] != null && row[0].ToString().Trim() != "")
                    {
                        Plantilla_Tributos tributo = new Plantilla_Tributos
                        {
                            ...
                            Periodo = row[1].ToString(),
                            Tributo = row[2].ToString(),
                            Tributo_Resultante = row[3].ToString() == "" ? 0 : double.Parse(row[3].ToString()),
                            Intereses = row[4].ToString() == "" ? 0 : double.Parse(row[4].ToString()),
                            Total_Pagar = row[5].ToString() == "" ? 0 : double.Parse(row[5].ToString()),
                            Forma_Pago = row[6].ToString(),
                            Egreso = row[7].ToString(),
                            Fecha_Informe = DateTime.Parse(row[8].ToString()),
                            Numero_Informe = row[9].ToString(),
                            Observaciones = row[10].ToString()
                        };
