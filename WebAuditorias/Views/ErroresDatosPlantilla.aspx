<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ErroresDatosPlantilla.aspx.cs" Inherits="WebAuditorias.Views.ErroresDatosPlantilla" %>
...
<head runat="server">
    ...
    <title>Detalle de errores de información de plantilla</title>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.3.2/js/bootstrap.min.js"></script></head>
        ...
        <div class="container-fluid">
            <div class="row header-bar-height" style="background-color: #E5E8E8;">
                ...
                <div class="col-sm-12 col-md-8 col-lg-8 col-xl-8 center-block text-left my-auto">
                    <p class="barra-titulo" style="color:#2C3E50;">Detalle de errores de información de plantilla</p>
                </div>  
            ...
            <div class="row console-menu-height" style="background-color: #B2BABB;">
                <div id="Contenedor" class="col-sm-12 col-md-12 col-lg-12 col-xl-12 px-4 py-4 bg-white h-100 opcion-backcolor-2" style="overflow-y: scroll;">
                    <div id="Formulario">
