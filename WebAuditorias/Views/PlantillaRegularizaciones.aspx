<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlantillaRegularizaciones.aspx.cs" Inherits="WebAuditorias.Views.PlantillaRegularizaciones" %>
...
<head runat="server">
    ...
    <title>Plantilla de regularizaciones</title>
...
<body style="margin: 0; height: 100%; overflow: hidden; background-color: #E5E8E8;">
        <div class="container-fluid">
            <div class="row header-bar-height" style="background-color: #E5E8E8;">
                ...
                <div class="col-sm-12 col-md-8 col-lg-8 col-xl-8 center-block text-left my-auto">
                    <p class="barra-titulo" style="color:#2C3E50;">Plantilla de regularizaciones</p>
                </div>  
                                            ...
                                            <div id="DivOpciones" class="px-2" style="overflow-x: hidden; overflow-y: auto" runat="server">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        ...
                                                        <input type="text" class="form-control form-control-sm" id="Detalle" placeholder="" runat="server" onclick="muestraContenidoTexto('Detalle', 'Detalle')"/>
                                                    </div>
                                                    <div class="form-group col-md-3">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-3">
                                                        <label for="Motivo" class="col-form-label col-form-label-sm" style="font-weight:bold;">Motivo</label>
                                                        <input type="text" class="form-control form-control-sm" id="Motivo" placeholder="" runat="server"/>
                                                    </div>
                                                    <div class="form-group col-md-3">
                                                        <label for="Banco_Ingreso" class="col-form-label col-form-label-sm" style="font-weight:bold;">Banco ingreso</label>
                                                        <input type="text" class="form-control form-control-sm" id="Banco_Ingreso" placeholder="" runat="server"/>
                                                    </div>
                                                    <div class="form-group col-md-3">
                                                        <label for="Banco_Regularizar" class="col-form-label col-form-label-sm" style="font-weight:bold;">Banco regularizar</label>
                                                        <input type="text" class="form-control form-control-sm" id="Banco_Regularizar" placeholder="" runat="server"/>
                                                    </div>
                                                    <div class="form-group col-md-3">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        ...
                                                        <input type="text" class="form-control form-control-sm" id="Soporte" placeholder="" runat="server" onclick="muestraContenidoTexto('Soporte', 'Soporte')"/>
                                                    </div>
                                                </div>
        ...
        <script src="../Scripts/PlantillaRegularizaciones.js" type="text/javascript"></script>
        <script>
