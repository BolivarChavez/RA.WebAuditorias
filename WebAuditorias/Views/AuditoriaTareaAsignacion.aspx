<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditoriaTareaAsignacion.aspx.cs" Inherits="WebAuditorias.Views.AuditoriaTareaAsignacion" %>
...
<head runat="server">
    ...
    <title>Asignaciones a tareas de auditoría</title>
...
<body style="margin: 0; height: 100%; overflow: hidden; background-color: #E5E8E8;">
    <div class="container-fluid">
        <div class="row header-bar-height" style="background-color: #E5E8E8;">
            ...
            <div class="col-sm-12 col-md-8 col-lg-8 col-xl-8 center-block text-left my-auto">
                <p class="barra-titulo" style="color:#2C3E50;">Asignaciones a tareas de auditoría</p>
            </div>  
                    ...
                    <form id="form1" runat="server">
                        ...
                        <ContentTemplate>
                            <nav class="navbar navbar-expand-lg">
                                ...
                                <button class="btn btn-outline-dark navbar-btn boton-buscar boton-margen" id="BtnBuscar" runat="server" onserverclick="BtnBuscar_ServerClick" data-toggle="tooltip" data-placement="bottom" title="Busca registros de asignaciones relacionadas a la tarea"></button>
                                <button class="btn btn-outline-dark navbar-btn boton-grabar boton-margen" id="BtnGrabar" runat="server" onserverclick="BtnGrabar_ServerClick" data-toggle="tooltip" data-placement="bottom" title="Graba registro de asignación relacionada a la tarea"></button>
                                <button class="btn btn-outline-dark navbar-btn boton-eliminar boton-margen" id="BtnEliminar" runat="server" onserverclick="BtnEliminar_ServerClick" data-toggle="tooltip" data-placement="bottom" title="Elimina registro de asignación relacionada a la tarea"></button>
                            </nav>
    ...
    <script src="../Scripts/AuditoriaTareaAsignacion.js" type="text/javascript"></script>
    <script>
