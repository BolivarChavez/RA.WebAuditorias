<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cotizaciones.aspx.cs" Inherits="WebAuditorias.Views.Cotizaciones" %>
...
<body style="background-color: #E5E8E8;">
        <div class="container-fluid">
            <div class="row header-bar-height" style="background-color: #E5E8E8;">
                ...
                <div class="col-sm-12 col-md-10 col-lg-10 col-xl-10 center-block text-left my-auto">
                    <p class="barra-titulo" style="color:#2C3E50;">Registro de cotizaciones</p>
                </div>  
            </div>
                        ...
                        <form id="form1" runat="server">
                            ...
                            <ContentTemplate>
                                <nav class="navbar navbar-expand-lg">
                                    ...
                                    <button class="btn btn-outline-dark navbar-btn boton-buscar boton-margen" id="BtnBuscar" runat="server" onserverclick="BtnBuscar_ServerClick" data-toggle="tooltip" data-placement="bottom" title="Busca registros de cotizaciones"></button>
                                    <button class="btn btn-outline-dark navbar-btn boton-grabar boton-margen" id="BtnGrabar" runat="server" onserverclick="BtnGrabar_ServerClick" data-toggle="tooltip" data-placement="bottom" title="Graba registro de cotización"></button>
                                </nav>
                                <div id="DivOpciones" class="px-2" runat="server">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="MonedaBase" CssClass="form-select form-select-sm" style="width: 250px" runat="server"></asp:DropDownList>
                                    </div>
                                    <div class="form-group">
                                        <label for="MonedaDestino" class="col-form-label col-form-label-sm" style="font-weight:bold;">Moneda Destino</label>
                                        <asp:DropDownList ID="MonedaDestino" CssClass="form-select form-select-sm" style="width: 250px" runat="server"></asp:DropDownList>
                                    </div>
                                    <div class="form-group">
                                        <label for="Cotizacion" class="col-form-label col-form-label-sm" style="font-weight:bold;">Cotización</label>
                                        <input type="number" class="form-control form-control-sm" style="width: 250px" id="Cotizacion" placeholder="" runat="server"/>
                                    </div>
                                    <div class="form-group">
                                        <label for="Fecha" class="col-form-label col-form-label-sm" style="font-weight:bold;">Fecha de Vigencia</label>
                                        <input type="date" class="form-control form-control-sm" style="width: 250px" id="Fecha" placeholder="" runat="server"/>
                                    </div>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Registro de cotizaciones</h5>
        ...
        <script src="../Scripts/Cotizaciones.js" type="text/javascript"></script>
        <script>
