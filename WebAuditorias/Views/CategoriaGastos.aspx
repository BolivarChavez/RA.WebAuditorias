<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CategoriaGastos.aspx.cs" Inherits="WebAuditorias.Views.CategoriaGastos" %>
...
<head runat="server">
    ...
    <title>Categorías de gastos asociados a auditorías</title>
...
<body style="background-color: #E5E8E8;">
        <div class="container-fluid">
            <div class="row header-bar-height" style="background-color: #E5E8E8;">
                ...
                <div class="col-sm-12 col-md-8 col-lg-8 col-xl-8 center-block text-left my-auto">
                    <p class="barra-titulo" style="color:#2C3E50;">Categorías de gastos asociados a auditorías</p>
                </div>  
                        ...
                        <form id="form1" runat="server">
                            ...
                            <ContentTemplate>
                                <nav class="navbar navbar-expand-lg">
                                    ...
                                    <button class="btn btn-outline-dark navbar-btn boton-buscar boton-margen" id="BtnBuscar" runat="server" onserverclick="BtnBuscar_ServerClick" data-toggle="tooltip" data-placement="bottom" title="Busca registros de categorías de gastos"></button>
                                    <button class="btn btn-outline-dark navbar-btn boton-grabar boton-margen" id="BtnGrabar" runat="server"  onserverclick="BtnGrabar_ServerClick" data-toggle="tooltip" data-placement="bottom" title="Graba registro de categorías de gastos"></button>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Categorías de gastos asociados a auditorías</h5>
        ...
        <script src="../Scripts/CategoriaGastos.js" type="text/javascript"></script>
        <script>
