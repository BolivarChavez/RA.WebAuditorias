                        ...
                        <form id="form1" runat="server">
                            ...
                            <ContentTemplate>
                                <nav class="navbar navbar-expand-lg">
                                    ...
                                    <button class="btn btn-outline-dark navbar-btn boton-cerrar boton-margen" id="BtnCerrar" runat="server" data-toggle="tooltip" data-placement="bottom" title="Cerrar registro de tarea relacionada a auditoría"></button>
                                </nav>
                                ...
                                <div id="Div1" class="mx-2" runat="server">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                                ...
                                                <asp:DropDownList ID="TipoProceso" CssClass="form-select form-select-sm" style="width: 300px" runat="server" Enabled="false"></asp:DropDownList>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="OficinaOrigen" class="col-form-label col-form-label-sm" style="font-weight:bold;">Oficina de origen</label>
                                            <asp:DropDownList ID="OficinaOrigen" CssClass="form-select form-select-sm" style="width: 300px" runat="server" Enabled="false"></asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            <label for="OficinaDestino" class="col-form-label col-form-label-sm" style="font-weight:bold;">Oficina de destino</label>
                                            <asp:DropDownList ID="OficinaDestino" CssClass="form-select form-select-sm" style="width: 300px" runat="server" Enabled="false"></asp:DropDownList>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="FechaInicio" class="col-form-label col-form-label-sm" style="font-weight:bold;">Fecha de Inicio</label>
                                            <input type="date" class="form-control form-control-sm" id="FechaInicio" placeholder="" style="width: 300px" runat="server" readonly="true"/>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="FechaCierre" class="col-form-label col-form-label-sm" style="font-weight:bold;">Fecha de Cierre</label>
                                            <input type="date" class="form-control form-control-sm" id="FechaCierre" placeholder="" style="width: 300px" runat="server" readonly="true"/>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            <label for="Tipo" class="col-form-label col-form-label-sm" style="font-weight:bold;">Tipo de auditoría</label>
                                            <asp:DropDownList ID="Tipo" CssClass="form-select form-select-sm" style="width: 300px" runat="server" Enabled="false">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control form-control-sm" id="Observaciones" placeholder="" runat="server" maxlength="400" readonly="true"/>
                                        </div>
                                        <div class="form-group col-md-4">
